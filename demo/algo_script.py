...
def test(n_gram):
    ...
    with open('./src/main/resources/algoresult/probability.json', 'w') as jsonfile:
        json.dump(user_dict['probability'], jsonfile, cls=NpEncoder)
    with open('./src/main/resources/algoresult/threshold.json', 'w') as jsonfile:
    ...
    #plt.show()
    plt.savefig('./src/main/resources/algoresult/probability.png')
